...
/* Tenho 21 funcionários no departamento de filmes e 53 no departamento de roupas */
SELECT * FROM funcionarios
WHERE departamento = 'Roupas'
OR
departamento = 'Filmes';

/* Funcionárias que trabalham no departamento Filmes ou departamento Lar */
SELECT COUNT(*) AS 'Quantidade por Sexo', SEXO FROM funcionarios
GROUP BY SEXO;

/* 491 Mulheres e 484 Homens */

SELECT COUNT(*) AS 'Quantidade de Pessoas por DP', departamento FROM funcionarios
GROUP BY departamento;

/* 21 pessoas trabalham com Filmes e 52 pessoas trabalham com Lar */
...
/* Funcionários do sexo masculino ou funcionários que trabalham com departamento Jardim */
SELECT * FROM funcionarios
WHERE
SEXO = 'Masculino'
OR
