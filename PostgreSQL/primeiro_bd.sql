...
create table funcionarios
  ...
  -- conferir o formato de data no PostgreSQL --
  show datestyle;
  
  -- dei um insert da Kelly, entrou com a data invertida porque o formato estava dya --
  ...
  -- nesse momento, mexi nas configurações do PostgreSQL dentro da pasta no Windows --
  -- C:\Program Files\PostgreSQL\10\data\postgresql.conf -> editei datestyle = 'iso, dmy' para mdy --
  -- depois eu reiniciei o PostgreSQL nos Serviços do Windows --
...
-- contando numero de ocorrencias --
...
-- exibindo o maior e menor salario --
...
select min(salario) as "Maior Salario", max(salario) as "Menor Salario" from funcionarios;

-- exibindo o salario minimo e maximo de cada departamento --
...
-- exibindo o salario minimo e maximo por sexo --
...
-- verificando as dez primeiras linhas de um dataset --
select * from funcionarios
limit 10;

-- qual o gasto total de salario pela empresa --
select sum(salario) from funcionarios;

-- qual o montante de total que cada departamento recebe de salario --
select departamento, sum(salario) as "Salario Total por Departamento"
from funcionarios
group by departamento;

-- por departamento, qual o total e a media paga para funcionarios --
select departamento, sum(salario) as "Total Salario", avg(salario) as "Media Salario"
from funcionarios
group by departamento;
...
group by departamento
order by 3;
-- ordenei pela terceira coluna -> media
